...
public static class Localization
{
    ...
    private static readonly Dictionary<string, string> Translations = new Dictionary<string, string>
    {
        ...
        { "Cần Câu", "Fishing Rod" },
        { "Cần Câu Cấp 1", "Fishing Rod Level 1" },
        { "Cần Câu Cấp 2", "Fishing Rod Level 2" },
        { "Cần Câu Cấp 3", "Fishing Rod Level 3" },
        { "Tràng Hạt", "Rosary" },
        ...
        { "Goblin chưa ở đây.", "The goblin isn't here." },
        { "Kho trống, goblin sẽ bỏ nông sản vào đây.", "Storage is empty; the goblin will drop crops here." },
