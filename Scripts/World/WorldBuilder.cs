...
private Transform _shopRoot;
    ...
    private readonly List<VendorCart> _vendorCartsToRemove = new List<VendorCart>();
...
var toRemove = _vendorCartsToRemove;
        toRemove.Clear();
...
public class ThrownCageProjectile : MonoBehaviour
{
    ...
    private void TryCapture(Livestock livestock)
    {
        ...
        {
            GameManager.Instance?.UIManager?.ShowMessage(Localization.T("Sai loại lồng!"), 1.5f);
        }
    }
