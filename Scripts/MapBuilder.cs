...
public static class MapBuilder
{
    ...
    public static GameObject BuildPlayerModel(Transform parent, float scale = 1f)
    {
        ...
        MakeBlock("HairL", root.transform, new Vector3(female ? 0.13f : 0.12f, female ? 0.3f : 0.2f, 0.26f), new Vector3(-0.17f, female ? 0.72f : 0.78f, 0f), hairC, true);
        MakeBlock("HairR", root.transform, new Vector3(female ? 0.13f : 0.12f, female ? 0.3f : 0.2f, 0.26f), new Vector3(0.17f, female ? 0.72f : 0.78f, 0f), hairC, true);
        if (female)
        {
    ...
    public static GameObject BuildSeatedPlayerModel(Transform parent, float scale = 1f)
    {
        ...
        Color skinC = new Color(220f / 255f, 178f / 255f, 132f / 255f);
        Color shirtC = female ? new Color(0.95f, 0.72f, 0.8f) : new Color(0.2f, 0.6f, 0.9f);
        Color pantsC = female ? new Color(0.9f, 0.88f, 0.92f) : new Color(0.25f, 0.25f, 0.35f);
        Color hairC = female ? new Color(0.16f, 0.1f, 0.08f) : new Color(0.2f, 0.12f, 0.05f);
        Color eyeC = new Color(0.05f, 0.03f, 0.01f);
        Color dressC = new Color(0.85f, 0.5f, 0.6f);
        ...
        if (female)
        {
            ...
            MakeBlock("SkirtHem", root.transform, new Vector3(0.46f, 0.05f, 0.36f), new Vector3(0f, -0.13f, 0f), new Color(0.75f, 0.4f, 0.5f), true);
        }
        // ── Head ──
        ...
        MakeBlock("HairL", root.transform, new Vector3(female ? 0.06f : 0.05f, female ? 0.24f : 0.16f, 0.1f), new Vector3(-0.16f, female ? 0.8f : 0.86f, 0f), hairC, true);
        MakeBlock("HairR", root.transform, new Vector3(female ? 0.06f : 0.05f, female ? 0.24f : 0.16f, 0.1f), new Vector3(0.16f, female ? 0.8f : 0.86f, 0f), hairC, true);
        if (female)
        {
            MakeBlock("HairBack", root.transform, new Vector3(0.28f, 0.26f, 0.08f), new Vector3(0f, 0.8f, -0.14f), hairC, true);
            MakeBlock("HairBand", root.transform, new Vector3(0.3f, 0.05f, 0.3f), new Vector3(0f, 0.9f, 0f), new Color(0.95f, 0.5f, 0.6f), true);
        }
        // ── Eyes ──
    ...
    public static GameObject BuildNightClub(Transform parent, Vector3 position, float scale = 1f, Quaternion rotation = default)
    {
        ...
        for (int tx = -3; tx <= 3; tx += 2)
        {
            for (int tz = -3; tz <= 3; tz += 2)
            {
    ...
    private static GameObject BuildClubDancer(Transform parent, Vector3 position, Quaternion rotation, Color shirtC, Color pantsC, Color skinC)
    {
        ...
        MakeBlock("ArmL", root.transform, new Vector3(0.13f, 0.5f, 0.13f), new Vector3(-0.35f, -0.05f, 0f), shirtC, true);
        MakeBlock("ArmR", root.transform, new Vector3(0.13f, 0.5f, 0.13f), new Vector3(0.35f, -0.05f, 0f), shirtC, true);
        MakeBlock("HandL", root.transform, new Vector3(0.11f, 0.1f, 0.11f), new Vector3(-0.35f, -0.28f, 0f), skinC, true);
        MakeBlock("HandR", root.transform, new Vector3(0.11f, 0.1f, 0.11f), new Vector3(0.35f, -0.28f, 0f), skinC, true);
